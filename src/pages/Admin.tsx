...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white shadow sticky top-0 z-40">
        <div className="max-w-6xl mx-auto px-2 sm:px-4 py-3 relative">
          <button
            onClick={() => setShowMobileFilters(true)}
            className="lg:hidden absolute left-2 top-1/2 -translate-y-1/2 flex flex-col items-center"
          >
            <Filter className="h-5 w-5 text-gray-700" />
            <span className="text-xs text-gray-700 mt-1">Filters</span>
          </button>
          <div className="flex flex-col items-center text-center">
            <h1 className="text-xl font-bold text-gray-900">Robot Vacuum Price</h1>
            <p className="text-xs text-gray-600 mt-0.5">(Affiliate Links)</p>
          </div>
        </div>
      </header>
  ...
  onClick={(e) => {
    console.log('View Deal button clicked for:', deal.deal_url); // Add click debug log
    e.preventDefault();
    e.stopPropagation();
